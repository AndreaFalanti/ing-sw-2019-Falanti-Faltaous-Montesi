...
public final class GuiResourcePaths {
    public static final String PLAYER_BOARD_UP = "/images/playerBoards/playerBoard";
    public static final String ACTION_TILE_UP = "/images/playerBoards/actionTileUp";
    ...
    public static final String POWER_UP_CARD = "/images/cards/AD_powerups_IT_";
